    ...
    return (
        <div className="projects">
            <section className="project1">
                <h4 className="Projtitle" id="NCtext">NC News</h4>
                <p className="Projtag">'endpoints galore'</p>
                <section className="Projbutton">
                <button className="btnStyle">learn more here!
                </button>
            </section>
            ...
            <div className="overlay"></div>
            <h4 className="Projtitle" id="ELtext">EuroLingo</h4>
            ...
            <h4 className="Projtitle" id="BCtext">Barclaysmen</h4>
